...
/**
 * Bridges web-auth/webauthn-lib 5.3+ (returns CredentialRecord) to laravel-webauthn 5.0.x which still types PublicKeyCredentialSource.
 */
class CredentialAttestationValidator extends CredentialValidator
{
    ...
    public function __invoke(User $user, array $data): PublicKeyCredentialSource
    {
        ...
        $credentialRecord = $this->validator->check(
